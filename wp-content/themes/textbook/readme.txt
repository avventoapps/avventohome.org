...
= 21 February 2018 =
* Add portfolio projects support to Featured Content.

= 30 January 2018 =
* Replacing get_them_mod() with get_option() to fix missing argument issue and

= 9 January 2018 =
* Ensure the featured image displays full width, if there's only 1 featured post.

= 9 December 2017 =
* Fix the search field display in the header search toggle.
